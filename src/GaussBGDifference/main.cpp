...
int main( int argc, char** argv )
{
   ...
   if(!capture.isOpened())
   {
    ...
    while(!pFrame.empty())
    {
        ...
        // OpenCV自带OTSU
        GaussBG.BackgroundDiff(pFrame, pFroundImg, pBackgroundImg, nFrmNum, CV_THRESH_OTSU);
        // 阈值筛选后的OTSU
        GaussBG.BackgroundDiff(pFrame, pFroundImg_c, pBackgroundImg_c, nFrmNum, CV_THRESH_BINARY);
