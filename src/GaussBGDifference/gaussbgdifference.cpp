 ...
 * method of Gauss Method & OTSU Algorithm By OpenCV.
 *
...
=====================================================================
*/
void GaussBGDiff::BackgroundDiff(Mat src, Mat &imgForeground, Mat& imgBackground, int nFrmNum, int threshold_method, double updateSpeed)
{
    // 源图像的灰度图像
...
void GaussBGDiff::Otsu(Mat src, int& thresholdValue, bool ToShowValue)
{
    // 输入图像是否为灰度图的标志位
